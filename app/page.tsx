...
export default function Portfolio() {
  ...
  <span className="text-amber-400">Easha</span> <span className="text-amber-400">Javed</span>
</h1>
              ...
              <CardHeader>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                  <div>
                    ...
                    <CardDescription className="text-lg text-gray-300 font-medium">Tutoria</CardDescription>
                  </div>
                  <div className="text-amber-400 font-semibold">November 2022 - January 2023</div>
                </div>
              </CardHeader>
              <CardContent>
                <p className="text-gray-300">Digital SAT course curriculum development</p>
              </CardContent>
            </Card>
          </div>
        </div>
